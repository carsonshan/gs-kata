...
public class Exercise1Test extends CompanyDomainForKata
{
    ...
    public void getCustomerCities()
    {
        ...
        MutableList<String> expectedCities = FastList.newListWith(CITY_LONDON, CITY_LIPHOOK, CITY_LONDON);
    ...
    public void getLondonCustomers()
    {
         ...
         */
        MutableList<Customer> customers = this.company.getCustomers();
        MutableList<Customer> customersFromLondon = customers.select(each -> each.getCity().equals(CITY_LONDON));
