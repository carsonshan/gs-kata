...
public class Exercise8Test extends CompanyDomainForKata {
    ...
    public void customersByCity() {
        ...
        MutableListMultimap<String, Customer> multimap = getCompanyCustomers().groupBy(Customer.TO_CITY);
    ...
    public void mapOfItemsToSuppliers() {
         ...
         */
        MutableMultimap<String, Supplier> itemsToSuppliers = ArrayIterate.groupByEach(getCompanySuppliers(), supplier -> FastList.newListWith(supplier.getItemNames()));
