...
public class Exercise2Test extends CompanyDomainForKata {
    ...
    public void getCustomerNames() {
         ...
         */
        MutableList<String> customerNames = getCompanyCustomers().collect(Customer.TO_NAME);
    ...
    public void getCustomerCities() {
         ...
         * constant on {@link Customer}.
         */
        MutableList<String> customerCities = getCompanyCustomers().collect(Customer.TO_CITY);
    ...
    public void getLondonCustomers() {
        MutableList<Customer> customersFromLondon = getCompanyCustomers().select(Predicates.attributeEqual(Customer.TO_CITY, CITY_LONDON));
